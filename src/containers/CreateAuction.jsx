...
function CreateAuction({ closemodal }) {
  ...
  return (
    <div className=" bg-white backdrop-blur-sm shadow-lg absolute top-0 w-full z-30 flex justify-center h-full">
      <div className=" bg-c-black  py-9 border  border-c-blue border-4 shadow-md w-1/3 my-auto px-9 ">
        <div
          onClick={closemodal}
        ...
        <DateTimePicker className="mt-2 bg-c-white h-10 w-full" onChange={onChange} value={value} />
